 ...
 * 饰品,JK制服-品牌维度拍摄步骤信息
 */
public class IdentifyExport_2 {

    public static void main(String[] args) throws Exception {
        String prefix = "【JK制服、饰品】";
        ...
        EasyExcel.read(sourceFile, ImportData.class, new AnalysisEventListener<ImportData>() {
            ...
            public void invoke(ImportData data, AnalysisContext analysisContext) {
                if (!data.getFirstClass().equals("饰品")) {
                    return;
                }
                // 系列
                try {
    ...
    public static class ImportData {
        ...
        @ExcelProperty(index = 0, value = "一级类目")
        ...
        @ExcelProperty(index = 12, value = "拍摄步骤 id")
        private Integer stepId;

        @ExcelProperty(index = 13, value = "拍摄步骤名称")
